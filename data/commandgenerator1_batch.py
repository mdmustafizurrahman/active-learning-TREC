        ...
        for lambda_param in lambda_list:
            for alpha_param in alpha_list:
                ...
                if variation%20 == 0:
                    ...
                    s = tmp + s + "\n"
                    filname = '/home/nahid/PycharmProjects/parser/newscript3/activeJobTREC8'+ str(variation)
...
filename1 = '/home/nahid/PycharmProjects/parser/newscript3/batch_command.sh'
print shellcommand
