...
mod = 10
filename1 = '/home/nahid/PycharmProjects/parser/newscript3/batch_command_WT.sh'
'''
...
mod = 3
filename1 = '/home/nahid/PycharmProjects/parser/newscript3/batch_command_gov2.sh'
'''

dataset = ['TREC8']
variation = 21 # dataset starts at 1 and we need 2 processor per job
mod = 5
filename1 = '/home/nahid/PycharmProjects/parser/newscript3/batch_command_TREC8.sh'
protocol_list = ['SPL']
        ...
        for lambda_param in lambda_list:
            for alpha_param in alpha_list:
                ...
                if variation%mod == 0:
                    ...
                    s = tmp + s + "\n\nwait"
                    filname = '/home/nahid/PycharmProjects/parser/newscript3/activeJobTREC'+ str(variation)
