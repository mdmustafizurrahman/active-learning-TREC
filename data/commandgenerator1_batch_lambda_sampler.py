...
mod = 10
filename1 = '/home/nahid/PycharmProjects/parser/scriptoversample/batch_command_WT.sh'
'''
...
mod = 10
filename1 = '/home/nahid/PycharmProjects/parser/scriptoversample/batch_command_gov2.sh'
'''
...
mod = 5
filename1 = '/home/nahid/PycharmProjects/parser/scriptoversample/batch_command_TREC8.sh'
        ...
        for lambda_param in lambda_list:
            for alpha_param in alpha_list:
                ...
                if variation%mod == 0:
                    ...
                    s = tmp + s + "\n\nwait"
                    filname = '/home/nahid/PycharmProjects/parser/scriptoversample/activeJobTREC'+ str(variation)
