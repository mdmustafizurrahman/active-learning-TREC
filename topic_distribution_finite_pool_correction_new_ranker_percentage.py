...
def get_topic_distribution():
    ...
    return topic_initial_X_train, topic_initial_Y_train, topic_seed_one_counter, topic_seed_zero_counter, topic_seed_counter, topic_train_index_list, total_judged, topic_train_percentage_loop_counter
...
for test_size in test_size_set:
    ...
    for fold in xrange(1,2):
        ...
        topic_initial_X_train, topic_initial_Y_train, topic_seed_one_counter, topic_seed_zero_counter, topic_seed_counter, topic_train_index_list, total_judged, topic_loopCounter = get_topic_distribution()
        topic_distribution = []
        for topic in xrange(start_topic, end_topic):
            print "Topic:", topic
            if topic in topicSkipList:
